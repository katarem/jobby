...
if __name__ == "__main__":
    ...
    results = job_service.get_job_offers(config)
    ...
    for i, result in enumerate(results):
        ...
        sanitized_content = final_content.encode('latin-1', 'replace').decode('latin-1')
        pdf_service.generate_card(sanitized_content, f'{config.card_name}_{i}.pdf')